// https://registry.terraform.io/providers/terraform-provider-openstack/openstack/3.0.0/docs/resources/vpnaas_endpoint_group_v2
...
export class VpnaasEndpointGroupV2 extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "openstack_vpnaas_endpoint_group_v2";
  ...
  * @param importFromId The id of the existing VpnaasEndpointGroupV2 that should be imported. Refer to the {@link https://registry.terraform.io/providers/terraform-provider-openstack/openstack/3.0.0/docs/resources/vpnaas_endpoint_group_v2#import import section} in the documentation of this resource for the id to use
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "openstack_vpnaas_endpoint_group_v2", importId: importFromId, provider });
      }
  ...
  */
  public constructor(scope: Construct, id: string, config: VpnaasEndpointGroupV2Config = {}) {
    super(scope, id, {
      terraformResourceType: 'openstack_vpnaas_endpoint_group_v2',
