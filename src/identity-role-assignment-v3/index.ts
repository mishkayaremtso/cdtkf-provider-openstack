// https://registry.terraform.io/providers/terraform-provider-openstack/openstack/3.0.0/docs/resources/identity_role_assignment_v3
...
export class IdentityRoleAssignmentV3 extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "openstack_identity_role_assignment_v3";
  ...
  * @param importFromId The id of the existing IdentityRoleAssignmentV3 that should be imported. Refer to the {@link https://registry.terraform.io/providers/terraform-provider-openstack/openstack/3.0.0/docs/resources/identity_role_assignment_v3#import import section} in the documentation of this resource for the id to use
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "openstack_identity_role_assignment_v3", importId: importFromId, provider });
      }
  ...
  */
  public constructor(scope: Construct, id: string, config: IdentityRoleAssignmentV3Config) {
    super(scope, id, {
      terraformResourceType: 'openstack_identity_role_assignment_v3',
