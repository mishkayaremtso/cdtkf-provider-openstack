// https://registry.terraform.io/providers/terraform-provider-openstack/openstack/3.0.0/docs
...
export class OpenstackProvider extends cdktf.TerraformProvider {
  ...
  * @param importFromId The id of the existing OpenstackProvider that should be imported. Refer to the {@link https://registry.terraform.io/providers/terraform-provider-openstack/openstack/3.0.0/docs#import import section} in the documentation of this resource for the id to use
