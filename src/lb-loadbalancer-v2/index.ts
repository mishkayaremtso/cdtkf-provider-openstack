// https://registry.terraform.io/providers/terraform-provider-openstack/openstack/3.0.0/docs/resources/lb_loadbalancer_v2
...
export class LbLoadbalancerV2 extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing LbLoadbalancerV2 that should be imported. Refer to the {@link https://registry.terraform.io/providers/terraform-provider-openstack/openstack/3.0.0/docs/resources/lb_loadbalancer_v2#import import section} in the documentation of this resource for the id to use
  ...
  */
  public constructor(scope: Construct, id: string, config: LbLoadbalancerV2Config = {}) {
    ...
    this._vipQosPolicyId = config.vipQosPolicyId;
  ...
  // vip_qos_policy_id - computed: false, optional: true, required: false
  private _vipQosPolicyId?: string; 
  public get vipQosPolicyId() {
    return this.getStringAttribute('vip_qos_policy_id');
  }
  public set vipQosPolicyId(value: string) {
    this._vipQosPolicyId = value;
  }
  public resetVipQosPolicyId() {
    this._vipQosPolicyId = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get vipQosPolicyIdInput() {
    return this._vipQosPolicyId;
  }
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      vip_qos_policy_id: cdktf.stringToTerraform(this._vipQosPolicyId),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      vip_qos_policy_id: {
        value: cdktf.stringToHclTerraform(this._vipQosPolicyId),
        isBlock: false,
        type: "simple",
        storageClassType: "string",
      },
